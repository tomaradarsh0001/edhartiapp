                    ...
                    <div class="tabs_container">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan=2><b>Date of Last Inspection Report:
                                                </b>{{$viewDetails->propertyInspectionDemandDetail->last_inspection_ir_date}} </td>
                                        </tr>
                                        <tr>
                                            <td><b>Date of Last Demand Letter:
                                                </b>{{$viewDetails->propertyInspectionDemandDetail->last_demand_letter_date}}</td>
                                            <td><b>Demand ID: </b>{{$viewDetails->propertyInspectionDemandDetail->last_demand_id}}</td>
                                        </tr>
                                        <tr>
                                            <td colspan=2><b>Amount of Last Demand Letter:
                                                </b>₹ {{$viewDetails->propertyInspectionDemandDetail->last_demand_amount}} </td>
                                        </tr>
                                        <tr>
                                            <td><b>Last Amount Received:
                                                </b>₹ {{$viewDetails->propertyInspectionDemandDetail->last_amount_received}} </td>
                                            <td><b>Date of Last Amount Received:
                                                </b>{{$viewDetails->propertyInspectionDemandDetail->last_amount_received_date}}
                                            </td>
                                        </tr>
                                        @else
                                        <p class="font-weight-bold">No Records Available</p>
                        ...
                        <div class="step-content" data-step="6" style="display: none;">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xl-8">
                                        <a href="#" class="btn btn-success">Download <i class='bx bxs-download'></i></a>
                                    </div>
                                    <div class="col-xl-4">
                                        <div class="btn-group">
