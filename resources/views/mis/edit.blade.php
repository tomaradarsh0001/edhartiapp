                    ...
                    <form method="POST" action="{{ route('mis.update', $propertyDetail->id) }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $propertyDetail->unique_file_no }}" id="fileNumberGenerated"
                                    ...
                                    <select class="form-select" name="present_colony_name" id="colonyName"
                                        ...
                                        @foreach ($colonyList as $colony)
                                            <option value="{{ $colony->id }}"
                                                {{ $propertyDetail->new_colony_name == $colony->id ? 'selected' : '' }}>
                                                {{ $colony->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <select class="form-select" name="old_colony_name" id="ColonyNameOld"
                                        ...
                                        @foreach ($colonyList as $colony)
                                            <option value="{{ $colony->id }}"
                                                {{ $propertyDetail->old_colony_name == $colony->id ? 'selected' : '' }}>
                                                {{ $colony->name }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-select" id="PropertyStatus" name="property_status"
                                        ...
                                        @foreach ($propertyStatus[0]->items as $status)
                                            <option value="{{ $status->id }}"
                                                {{ $propertyDetail->status == $status->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-select" id="LandType" name="land_type"
                                        ...
                                        @foreach ($landTypes[0]->items as $landType)
                                            <option value="{{ $landType->id }}"
                                                {{ $propertyDetail->land_type == $landType->id ? 'selected' : '' }}>
                                                {{ $landType->item_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('land_type')
                                        <span class="errorMsg">{{ $message }}</span>
                            ...
                            <div class="row g-3">
                                    ...
                                    <select class="form-select" name="lease_type" id="TypeLease"
                                        ...
                                        @foreach ($leaseTypes[0]->items as $leaseType)
                                            <option value="{{ $leaseType->id }}"
                                                {{ $propertyLeaseDetail->type_of_lease == $leaseType->id ? 'selected' : '' }}>
                                                {{ $leaseType->item_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('lease_type')
                                        <span class="errorMsg">{{ $message }}</span>
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <input type="date" class="form-control" name="date_of_expiration"
                                        id="dateOfExpiration" value="{{ $propertyLeaseDetail->date_of_expiration }}">
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <input type="date" name="date_of_allotment" class="form-control"
                                        id="dateallotment" value="{{ $propertyLeaseDetail->doa }}">
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <input type="text" name="block_no" class="form-control" id="blockno"
                                        maxlength="4" placeholder="Block No." value="{{ $propertyDetail->block_no }}">
                                    @error('block_no')
                                        <span class="errorMsg">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-12 col-lg-12">
                                    ...
                                    <div>
                                        <div class="col-12 col-lg-12">
                                            ...
                                            <button type="button"
                                                class="btn btn-outline-primary repeater-add-btn-in-favor"
                                                ...
                                                <div class="items">
                                                    ...
                                                    <div class="item-content">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="original[{{ $originalData->id }}]"
                                                                placeholder="Name" id="original" data-name="name"
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="presentlyknownsas"
                                        name="presently_known" value="{{ $propertyLeaseDetail->presently_known_as }}">
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <div class="unit-field">
                                        <input type="text" class="form-control unit-input" id="areaunitname"
                                            name="area" value="{{ $propertyLeaseDetail->plot_area }}">
                                        <select class="form-select unit-dropdown" id="selectareaunit"
                                            ...
                                            @foreach ($areaUnit[0]->items as $unit)
                                                <option value="{{ $unit->id }}"
                                                    {{ $propertyLeaseDetail->unit == $unit->id ? 'selected' : '' }}>
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <div class="unit-field">
                                        <input type="text" class="form-control mr-2" id="premiumunit1"
                                            name="premium1" value="{{ $propertyLeaseDetail->premium }}">
                                        ...
                                        <select class="form-select unit-dropdown" name="premium_unit"
                                            ...
                                            <option value="1"
                                                {{ $propertyLeaseDetail->premium_in_paisa != null ? 'selected' : '' }}>
                                                Paise</option>
                                            <option value="2"
                                                {{ $propertyLeaseDetail->premium_in_aana != null ? 'selected' : '' }}>
                                                Ana</option>
                                        </select>
                                    </div>
                                    @error('premium1')
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <div class="unit-field">
                                        <input type="text" class="form-control mr-2" id="groundRent1"
                                            name="ground_rent1" value="{{ $propertyLeaseDetail->gr_in_re_rs }}">
                                        ...
                                        <select class="form-select unit-dropdown" id="selectGroundRentUnit"
                                            ...
                                            <option value="">Unit</option>
                                            <option value="1"
                                                {{ $propertyLeaseDetail->gr_in_paisa != null ? 'selected' : '' }}>
                                                Paise</option>
                                            <option value="2"
                                                {{ $propertyLeaseDetail->gr_in_aana != null ? 'selected' : '' }}>
                                                Ana</option>
                                        </select>
                                    </div>
                                    ...
                                    <select class="form-select" id="oldPropertyType" aria-label="Type of Lease"
                                        ...
                                        @foreach ($propertyTypes[0]->items as $propertyType)
                                            <option value="{{ $propertyType->id }}"
                                                {{ $propertyLeaseDetail->property_type_as_per_lease == $propertyType->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-select" id="oldPropertySubType" aria-label="Type of Lease"
                                        ...
                                        @foreach ($subTypes as $subType)
                                            <option value="{{ $subType->id }}"
                                                {{ $propertyLeaseDetail->property_sub_type_as_per_lease == $subType->id ? 'selected' : '' }}>
                                                {{ $subType->item_name }}</option>
                                        @endforeach
                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-lg-6">
                                                    ...
                                                    <select class="form-select" id="propertyType"
                                                        ...
                                                        @foreach ($propertyTypes[0]->items as $propertyType)
                                                            <option value="{{ $propertyType->id }}"
                                                                {{ $propertyLeaseDetail->property_type_at_present == $propertyType->id ? 'selected' : '' }}>
                                                                {{ $propertyType->item_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    ...
                                                    <select class="form-select" id="propertySubType"
                                                        ...
                                                        @foreach ($subTypesNew as $subType)
                                                            <option value="{{ $subType->id }}"
                                                                {{ $propertyLeaseDetail->property_sub_type_at_present == $subType->id ? 'selected' : '' }}>
                                                                {{ $subType->item_name }}</option>
                                                        @endforeach
                                                    </select>
                                ...
                                <div class="col-12 col-lg-12 mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="form-check mr-2">
                                            <input class="form-check-input" type="checkbox" name="transferred"
                                                value="1" id="transferredFormYes"
                                                {{ count($filteredTransferDetails) > 0 ? 'checked' : '' }}>
                                    ...
                                    <div class="transferred-container" id="transferredContainer">
                                        <div class="row">
                                            <div class="col-12 col-lg-12">
                                                                ...
                                                                <div class="col-12 col-lg-4 my-4">
                                                                    ...
                                                                    <select name="land_transfer_type[]"
                                                                        ...
                                                                        <option value="Substitution"
                                                                            {{ $process == 'Substitution' ? 'selected' : '' }}>
                                                                            Substitution</option>
                                                                        <option value="Mutation"
                                                                            {{ $process == 'Mutation' ? 'selected' : '' }}>
                                                                            Mutation</option>
                                                                        ...
                                                                        <option value="Others"
                                                                            {{ $process == 'Others' ? 'selected' : '' }}>
                                                                            Others</option>
                                                                    </select>
                                                                    <div id="ProcessTransferError" class="text-danger">
                                                                    </div>
                                                                </div>
                                                                <div class="col-12 col-lg-4 my-4">
                                                                    ...
                                                                    <input type="date" name="transferDate[]"
                                                                        ...
                                                                        value="{{ $date }}"
                                                                        id="transferredDate">
                                                                    <div id="transferredDateError" class="text-danger">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            {{-- @if ($l == 1) --}}
                                                ...
                                                <button type="button"
                                                    class="add-parent-button-new btn btn-outline-primary"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="form-check mr-2">
                                                {{-- <input class="form-check-input" type="radio" name="freeHold"
                                                    ...
                                                    {{ $propertyDetail->status == 952 ? 'checked' : 'disabled' }}> --}}
                                                <input class="form-check-input" type="radio" name="freeHold"
                                                    value="Yes" id="freeHoldFormYes"
                                                    {{ $propertyDetail->status == 952 ? 'checked' : '' }}>
                                ...
                                <div id="property_status_vacant">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="form-check mr-2">
                                                {{-- <input class="form-check-input" type="radio" name="landType"
                                                    ...
                                                    {{ $propertyDetail->status == 1124 ? 'checked' : 'disabled' }}> --}}
                                                <input class="form-check-input" type="radio" name="landType"
                                                    value="Yes" id="landTypeFormYes"
                                                    {{ $propertyDetail->status == 1124 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="landType-container row" id="landTypeContainer"
                                            style="{{ $propertyDetail->status != 1124 ? 'display: none;' : '' }}">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-lg-6">
                                                    ...
                                                    <select class="form-select" id="TypeLease" name="in_possession_of"
                                                        ...
                                                        <option value="">Select</option>
                                                        <option value="1"
                                                            {{ $propertyLeaseDetail->in_possession_of_if_vacant == 1 ? 'selected' : '' }}>
                                                            DDA</option>
                                                        <option value="2"
                                                            {{ $propertyLeaseDetail->in_possession_of_if_vacant == 2 ? 'selected' : '' }}>
                                                            NDMC</option>
                                                        <option value="3"
                                                            {{ $propertyLeaseDetail->in_possession_of_if_vacant == 3 ? 'selected' : '' }}>
                                                            MCD</option>
                                                    </select>
                                                </div>
                                                <div class="col-12 col-lg-6">
                                ...
                                <div id="property_status_others">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="form-check mr-2">
                                                {{-- <input class="form-check-input" type="radio" name="landTypeOthers"
                                                    ...
                                                    {{ $propertyDetail->status == 1342 ? 'checked' : 'disabled' }}> --}}
                                                <input class="form-check-input" type="radio" name="landTypeOthers"
                                                    value="Yes" id="landTypeFormOthersYes"
                                                    {{ $propertyDetail->status == 1342 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="landType-container row" id="landTypeOthersContainer"
                                            style="{{ $propertyDetail->status != 1342 ? 'display: none;' : '' }}">
                        ...
                        <div id="test-vl-6" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <div class="row g-3">
                                            ...
                                            @if ($propertyMiscDetail->is_gr_revised_ever == 1)
                                                <div class="col-12 col-lg-4">
                                                    ...
                                                    <input type="date" name="gr_revised_date" class="form-control"
                                                        id="GRrevisedDate"
                                                        value="{{ $propertyMiscDetail->gr_revised_date }}">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                @endif
                                @if (isset($propertyMiscDetail->is_supplimentry_lease_deed_executed) &&
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="form-check mr-2">
                                                <input class="form-check-input" type="radio" name="Reentered"
                                                    ...
                                                    {{ $propertyMiscDetail->is_re_rented == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="Reentered"
                                                    value="0" id="ReenteredFormNo"
                                                    {{ $propertyMiscDetail->is_re_rented == 0 ? 'checked' : '' }}>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <input type="email" name="email" class="form-control" id="Email"
                                        placeholder="Email" value="{{ $propertyContactDetail->email }}">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === true) {
                            ...
                            $("#ColonyNameOld option[value=" + response.data.colony_id + "]").attr(
                                'selected', true);
                            $("#PropertyStatus option[value=" + response.data.property_status + "]")
                                .attr('selected', true);
                            $("#LandType option[value=" + response.data.land_type + "]").attr(
                                'selected', true);
