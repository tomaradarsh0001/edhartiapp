        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li class="{{ request()->is('new/application') ? 'active' : '' }}"> <a
                                href="{{ route('new.application') }}"><i class="bx bx-right-arrow-alt"></i>New Application</a>
                        </li>
                        <li> <a href="javascript:;"><i class="bx bx-down-arrow-alt"></i>Application History</a>
                            <ul>
                                <li> <a href="#">View Details</a></li>
                                <li> <a href="#">Previous Applications</a></li>
                                <li> <a href="#">Withdraw/Cancel Applications</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
