...
<head>
    ...
    <link rel="stylesheet" type="text/css" id="style_sheet" href="{{asset('assets/frontend/assets/css/skins/default.css')}}">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 col-7">
              <a class="navbar-brand" href="#">
                  <img src="{{asset('assets/frontend/assets/img/LDOLogo-white.png')}}" alt="Land and Development Office" height="60">
                </a>
          </div>
          <div class="col-lg-6 col-5 text-end">
            <div class="d-flex justify-content-end"><img src="{{asset('assets/frontend/assets/img/eDharti-Logo-white.png')}}" alt="logo" class="edharti-logo"><span class="text-white">2.0</span></div>
        </div>
        </div>
      </div>
  </nav>
            ...
            <form action="#" id="otp-form">
                <div class="otp-receive-container">
                    <div class="otp_input_groups">
                      ...
                      <button type="button" id="verifyMobileOtpBtn" class="btn otp_verify_btn">Verify Mobile Number</button>
            ...
            <form action="#" id="otp-form-email">
                <div class="otp-receive-container">
                    <div class="otp_input_groups">
                      ...
                      <button type="button" id="verifyEmailOtpBtn" class="btn otp_verify_btn">Verify Email</button>
                      <p class="resent_otp">Didn't receive code? <a href="#">Resend</a></p>
                </div>
            </form>
        </div>
            ...
            <form action="#" id="org-otp-form">
                <div class="otp-receive-container">
                    <div class="otp_input_groups">
                      ...
                      <button type="button" id="orgVerifyMobileOtpBtn" class="btn otp_verify_btn">Verify Mobile Number</button>
                      <p class="resent_otp">Didn't receive code? <a href="#">Resend</a></p>
                </div>
            </form>
        </div>
            ...
            <form action="#" id="org-otp-form-email">
                <div class="otp-receive-container">
                    <div class="otp_input_groups">
                      ...
                      <button type="button" id="orgVerifyEmailOtpBtn" class="btn otp_verify_btn">Verify Email</button>
                      <p class="resent_otp">Didn't receive code? <a href="#">Resend</a></p>
                </div>
            </form>
        </div>
