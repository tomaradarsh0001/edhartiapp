                ...
                <div class="right-container">
                    <div class="tab-content-container">
                            ...
                            <div class="row col-partition">
                                <div class="col-lg-4">
                                    ...
                                    <ul class="nav-links">
                                        ...
                                        <li><a href="{{ url('users') }}"><i class='bx bx-chevron-right'></i> Add User</a></li>
                                        <li><a href="{{ url('users') }}"><i class='bx bx-chevron-right'></i> Role Management</a></li>
                        ...
                        <div id="Purchase" class="tabcontent">
                            <ul class="nav-links">
                                <li><a href="{{ url('logistic/category') }}"><i class='bx bx-chevron-right'></i> Add
                                        Category</a>
                                </li>
                                <li><a href="{{ url('logistic/items') }}"><i class='bx bx-chevron-right'></i> Add
                                        Items</a></li>
                                <li><a href="{{ url('logistic/vendor') }}"><i class='bx bx-chevron-right'></i> Supplier/Vendor
                                        List</a>
                                </li>

                                <li><a href="{{ url('logistic/purchase') }}"><i class='bx bx-chevron-right'></i> Purchase</a>
                                </li>

                                <li><a href="{{ url('/logistic/issued-item') }}"><i class='bx bx-chevron-right'></i> Issue an
                                        Item</a>
                                </li>
                                <li><a href="{{ url('/logistic/requested-items') }}"><i class='bx bx-chevron-right'></i> Issue
                                        Requests</a>
                                </li>

                                <li><a href="{{ url('logistic/history') }}"><i class='bx bx-chevron-right'></i> Stock History</a>
                                </li>
                                <li><a href="{{ url('logistic/stock') }}"><i class='bx bx-chevron-right'></i> Available Stock</a>
                                </li>
                            </ul>
                        </div>
