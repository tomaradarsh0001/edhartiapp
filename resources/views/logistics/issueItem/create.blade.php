    ...
    <div class="card-body">
        ...
        <form action="{{ route('issued_item.store') }}" method="POST" id="issueItemsForm">
                    ...
                    <div class="row m-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="items[0][logistic_items_id]" id="logistic_items_id" class="form-select item-select" required>
                                    <option value="">Select</option>
                                    @foreach ($logisticItems as $item)
                                        <option value="{{ $item->id }}" data-category-id="{{ $item->category_id }}" data-available-units="{{ $availableUnits[$item->id] ?? 0 }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="items[0][category_id]" id="category_id" class="form-select category-select" required>
                                    <option value="">Select</option>
                    ...
                    <div class="row m-3">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="items[0][available_units]" id="available_units" class="form-control available-units" value="0" disabled>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="issued_units" class="required">Issued Units</label>
                                <input type="number" name="items[0][issued_units]" id="issued_units" class="form-control issued-units" required>
                                <div class="error-message" style="color: red; display: none;"></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-1 mt-3 text-end">
                            <button type="button" class="btn btn-danger remove-btn px-4 py-2" data-toggle="tooltip" title="Click to delete this form" data-bs-target="#ModalDelete" disabled>
            ...
            <div class="d-flex justify-content-end p-3">
                <button type="button" id="duplicate-form" class="btn btn-outline-primary repeater-add-btn" data-toggle="tooltip" title="Add more items" data-placement="bottom">
