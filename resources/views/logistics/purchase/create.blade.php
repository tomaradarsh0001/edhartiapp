            ...
            <div class="common-form m-3"
                ...
                <div class="form-row m-3">
                    <div class="form-group col-md-6">
                        <label class="form-label" for="vendor_supplier_id">Vendor Supplier Name: <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group col-md-6">
                        <label class="form-label" for="purchased_date">Purchased Date: <span class="text-danger">*</span></label>
                ...
                <div class="form-row m-3">
                    @include('logistics.purchase.repeater-create', ['prefix' => '', 'purchaseCategory' => $purchaseCategory, 'purchaseItem' => $purchaseItem])
                </div>
                ...
                <div id="repeater-container">
                    <div class="repeater-box repeater-item-template">
                        <div class="row m-1 mb-3 align-items-center">
                            @include('logistics.purchase.repeater-create', ['prefix' => 'repeater[0][', 'purchaseCategory' => $purchaseCategory, 'purchaseItem' => $purchaseItem])
                            <div class="col-md-1">
                                <div class="text-end">
...
$(document).ready(function () {
    ...
    function disableSelectedItems() {
        ...
        $('select[name="logistic_items_id"], select[name^="repeater"][name$="[logistic_items_id]"]').each(function () {
            if ($(this).val() !== "") {
    ...
    function updateCategory(selectElement) {
        ...
        var categorySelect = selectElement.closest('.form-row, .row').find('select[name$="[category_id]"], select[name="category_id"]');
    ...
    function validateForm() {
        ...
        $('div.repeater-box').not('.repeater-item-template').each(function () {
            var logisticItemsId = $(this).find('select[name^="repeater"][name$="[logistic_items_id]"]');
            ...
            if (purchasedUnit.length > 0) {
                ...
                if (isNaN(purchasedUnitValue) || purchasedUnitValue < 1) {
                    ...
                    purchasedUnit.after('<div class="error-message">Value must be 1 or more.</div>');
