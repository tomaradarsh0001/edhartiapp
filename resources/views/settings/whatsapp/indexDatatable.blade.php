    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between py-3">
                ...
                <a href="{{ route('settings.whatsapp.create') }}"><button class="btn btn-primary">+ Add
                        Whatsapp</button></a>
            </div>
                        ...
                        <tr class="">
                            ...
                            <td>
                                @php
                                    ...
                                    $key =
                                        $length > 4
                                            ? str_repeat('x', $length - 4) . substr($data->key, -4)
                                            : $data->key;
                                @endphp
                                {{ $key }}
                            </td>
                            <td>
                                @php
                                    ...
                                    $password =
                                        $length > 4
                                            ? str_repeat('x', $length - 4) . substr($data->auth_token, -4)
                                            : $data->auth_token;
                                @endphp
                                {{ $password }}
                            </td>
                                    ...
                                    @else
                                        <a href="{{ route('settings.whatsapp.status', $data->id) }}">
                                            <div
                                                ...
                                                <i class="bx bxs-circle me-1"></i>In-Active</div>
                                        </a>
                                    @endif
                                @else
                                    @if ($data->status == 1)
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#example').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: "{{ route('get.whatsapp.settings') }}",
                    type: "GET",
