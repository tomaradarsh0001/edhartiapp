    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    @forelse($sms as $index => $data)
                    <tr class="">
                        <th scope="row">{{$index+1}}</th>
                        <td>
                            <div class="testSms text-primary" data-id="{{$data->id}}">Test Sms</div>
                        ...
                        <td>
                            ...
                            @if($data->status == 1)
                            <a href="{{route('settings.sms.status',$data->id)}}">
                        ...
                        <td>
                            <div class="d-flex gap-3">
                                <a href="{{route('settings.sms.edit',$data->id)}}"><button type="button"
                    ...
                    @empty
                    <p class="text-danger text-center text-capitalize fs-5">No Sms available</p>
                    @endforelse
