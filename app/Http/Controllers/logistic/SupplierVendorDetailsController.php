...
class SupplierVendorDetailsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        UserActionLogHelper::UserActionLog('create', url("/logistic/vendor"), 'vendors', "New logistic vendor " . $action_link . " has been created by " . Auth::user()->name.".");
        return redirect('logistic/vendor')->with('success', 'Vendor created successfully.');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('logistic/vendor')->with('success', 'Data updated successfully');
    }
