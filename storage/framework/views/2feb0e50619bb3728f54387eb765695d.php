                    ...
                    <li>
                        ...
                        <ul>
                            <li class="<?php echo e(request()->is('reports') ? 'active' : ''); ?>"> <a
                                    href="<?php echo e(route('reports.index')); ?>"><i class="bx bx-right-arrow-alt"></i>Reports</a>
                            </li>
                            <li class="<?php echo e(request()->is('tabular-record') ? 'active' : ''); ?>"> <a
                                    href="<?php echo e(route('tabularRecord')); ?>"><i class="bx bx-right-arrow-alt"></i>Tabular
                                    Record</a>
                            </li>
                        </ul>
                    </li>
                ...
                <li>
                    ...
                    <ul>
                        <li class="<?php echo e(request()->is('property-form') ? 'active' : ''); ?>"> <a
                                href="<?php echo e(route('mis.index')); ?>"><i class="bx bx-right-arrow-alt"></i>Add Property</a>
                        </li>
                        ...
                        <?php if (\Illuminate\Support\Facades\Blade::check('haspermission', 'viewDetails')): ?>
                            <li class="<?php echo e(request()->is('property-details') ? 'active' : ''); ?>"> <a
                                    href="<?php echo e(route('propertDetails')); ?>"><i class="bx bx-right-arrow-alt"></i>View
                                    Details</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                ...
                <li>
                    ...
                    <ul>
                        <li class="<?php echo e(request()->is('applicant/profile') ? 'active' : ''); ?>"> <a
                                href="<?php echo e(route('applicant.profile')); ?>"><i
                                    class="bx bx-right-arrow-alt"></i>Profile <?php echo e(request()->is()); ?></a>
                        </li>
...
<?php /**PATH C:\Users\shubh\Desktop\new 22 august\eDharti\resources\views/layouts/app.blade.php ENDPATH**/ ?>