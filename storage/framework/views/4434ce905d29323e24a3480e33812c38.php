    ...
    <div class="row row-cols-2 row-cols-md-2 row-cols-xl-4 custom_card_container">
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin"><img src="<?php echo e(asset('assets/images/properties-icon-hand-Total.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark" id="tile_total_count" data-original="<?php echo e(customNumFormat($totalCount)); ?>"><?php echo e(customNumFormat($totalCount)); ?></h4>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #FFF3E0;"><img src="<?php echo e(asset('assets/images/pageless-Total.svg')); ?>" alt="Pageless">
                        </div>
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark" id="tile_total_area_formatted" data-original="<?php echo e(customNumFormat(round($totalArea))); ?>"><?php echo e(customNumFormat(round($totalArea))); ?></h4>
        ...
        <div class="col hoverable" title="₹<?php echo e(customNumFormat($totalLdoValue)); ?>" id="tile_total_land_value_ldo" data-original="₹<?php echo e(customNumFormat($totalLdoValue)); ?>">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #F3E5F5;"><img src="<?php echo e(asset('assets/images/sell-Total.svg')); ?>" alt="Land Value">
                        </div>
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark" id="tile_total_land_value_ldo_formatted" data-original="₹<?php echo e(customNumFormat(round($totalLdoValue/10000000))); ?> Cr.">₹<?php echo e(customNumFormat(round($totalLdoValue/10000000))); ?> Cr.</h4>
        ...
        <div class="col hoverable" title="₹<?php echo e(customNumFormat($totalCircleValue)); ?>" id="tile_total_land_value_circle" data-original="₹<?php echo e(customNumFormat($totalCircleValue)); ?>">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #E0F2F1;"><img src="<?php echo e(asset('assets/images/payments-Total.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 text-dark grid-icons-size" id="tile_total_land_value_circle_formatted" data-original="₹<?php echo e(customNumFormat(round($totalCircleValue/10000000))); ?> Cr.">₹<?php echo e(customNumFormat(round($totalCircleValue/10000000))); ?> Cr.</h4>
    ...
    <div class="row row-cols-2 row-cols-md-2 row-cols-xl-4 custom_card_container">
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #FFEBEE;"><img src="<?php echo e(asset('assets/images/properties-icon-hand-LH.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark" id="tile_lease_hold_count" data-original="<?php echo e(customNumFormat($statusCount['lease_hold'])); ?>"><?php echo e(customNumFormat($statusCount['lease_hold'])); ?></h4>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #FFF3E0;"><img src="<?php echo e(asset('assets/images/pageless-LH.svg')); ?>" alt="Pageless">
                        </div>
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark" id="tile_lease_hold_area" data-original="<?php echo e(customNumFormat(round($statusArea['lease_hold']))); ?>"><?php echo e(customNumFormat(round($statusArea['lease_hold']))); ?></h4>
        ...
        <div class="col hoverable" title="₹<?php echo e(customNumFormat($statusLdoValue['lease_hold'])); ?>" id="tile_lease_hold_land_value_ldo" data-original="₹<?php echo e(customNumFormat($statusLdoValue['lease_hold'])); ?>">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #F3E5F5;"><img src="<?php echo e(asset('assets/images/sell-LH.svg')); ?>" alt="Land Value">
                        </div>
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark" id="tile_lease_hold_land_value_ldo_formatted" data-original="₹<?php echo e(customNumFormat(round($statusLdoValue['lease_hold']/10000000))); ?> Cr.">₹<?php echo e(customNumFormat(round($statusLdoValue['lease_hold']/10000000))); ?> Cr.</h4>
        ...
        <div class="col hoverable" title="₹<?php echo e(customNumFormat($statusCircleValue['lease_hold'])); ?>" id="tile_lease_hold_land_value_circle" data-original="₹<?php echo e(customNumFormat($statusCircleValue['lease_hold'])); ?>">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #E0F2F1;"><img src="<?php echo e(asset('assets/images/payments-LH.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 text-dark grid-icons-size" id="tile_lease_hold_land_value_circle_formatted" data-original="₹<?php echo e(customNumFormat(round($statusCircleValue['lease_hold']/10000000))); ?> Cr.">₹<?php echo e(customNumFormat(round($statusCircleValue['lease_hold']/10000000))); ?> Cr.</h4>
    ...
    <div class="row row-cols-2 row-cols-md-2 row-cols-xl-4 custom_card_container">
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #FFEBEE;"><img src="<?php echo e(asset('assets/images/properties-icon-hand.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark" id="tile_free_hold_count" data-original="<?php echo e(customNumFormat($statusCount['free_hold'])); ?>"><?php echo e(customNumFormat($statusCount['free_hold'])); ?></h4>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #FFF3E0;"><img src="<?php echo e(asset('assets/images/pageless.svg')); ?>" alt="Pageless">
                        </div>
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark" id="tile_free_hold_area" data-original="<?php echo e(customNumFormat(round($statusArea['free_hold']))); ?>"><?php echo e(customNumFormat(round($statusArea['free_hold']))); ?></h4>
        ...
        <div class="col hoverable" title="₹<?php echo e(customNumFormat($statusLdoValue['free_hold'])); ?>" id="tile_free_hold_land_value_ldo" data-original="₹<?php echo e(customNumFormat($statusLdoValue['free_hold'])); ?>">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #F3E5F5;"><img src="<?php echo e(asset('assets/images/sell.svg')); ?>" alt="Land Value">
                        </div>
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark" id="tile_free_hold_land_value_ldo_formatted" data-original="₹<?php echo e(customNumFormat(round($statusLdoValue['free_hold']/10000000))); ?> Cr.">₹<?php echo e(customNumFormat(round($statusLdoValue['free_hold']/10000000))); ?> Cr.</h4>
        ...
        <div class="col hoverable" title="₹<?php echo e(customNumFormat($statusCircleValue['free_hold'])); ?>" id="tile_free_hold_land_value_circle" data-original="₹<?php echo e(customNumFormat($statusCircleValue['free_hold'])); ?>">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #E0F2F1;"><img src="<?php echo e(asset('assets/images/payments.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 text-dark grid-icons-size" id="tile_free_hold_land_value_circle_formatted" data-original="₹<?php echo e(customNumFormat(round($statusCircleValue['free_hold']/10000000))); ?> Cr.">₹<?php echo e(customNumFormat(round($statusCircleValue['free_hold']/10000000))); ?> Cr.</h4>
            ...
            <div class="card green-gradient">
                <div class="container-fluid">
                    <div class="row row-cols-xl-2 row-cols-1">
                        <div class="card-body">
                            <div class="d-flex align-items-center dashboard-cards">
                                <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #fff;"><img src="<?php echo e(asset('assets/images/properties-icon-hand.svg')); ?>" alt="properties">
                                </div>
                                <div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center dashboard-cards">
                                <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin" style="background-color: #fff;"><img src="<?php echo e(asset('assets/images/payments.svg')); ?>" alt="properties">
                                </div>
                                <div>
    ...
    <div class="row row-cols-2 row-cols-md-2 row-cols-xl-6 custom_card_container">
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        <div class="widgets-icons-2 rounded-circle text-white m-auto" style="background-color: #E0F2F1;"><img src="<?php echo e(asset('assets/images/residential.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 text-dark" id="residential_count" data-original="<?php echo e(customNumFormat($propertyTypeCount['Residential'])); ?>"><?php echo e(customNumFormat($propertyTypeCount['Residential'])); ?></h4>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        <div class="widgets-icons-2 rounded-circle text-white m-auto" style="background-color: #FFF3E0;"><img src="<?php echo e(asset('assets/images/commercial.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 text-dark" id="commercial_count" data-original="<?php echo e(customNumFormat($propertyTypeCount['Commercial'])); ?>"><?php echo e(customNumFormat($propertyTypeCount['Commercial'])); ?></h4>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        <div class="widgets-icons-2 rounded-circle text-white m-auto" style="background-color: #FFEBEE;"><img src="<?php echo e(asset('assets/images/factory.svg')); ?>" alt="Industrial">
                        </div>
                        <div>
                            <h4 class="my-1 text-dark" id="industrial_count" data-original="<?php echo e(customNumFormat($propertyTypeCount['Industrial'])); ?>"><?php echo e(customNumFormat($propertyTypeCount['Industrial'])); ?></h4>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        <div class="widgets-icons-2 rounded-circle text-white m-auto"><img src="<?php echo e(asset('assets/images/institute-Inst.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 text-dark" id="institutional_count" data-original="<?php echo e(customNumFormat($propertyTypeCount['Institutional'])); ?>"><?php echo e(customNumFormat($propertyTypeCount['Institutional'])); ?></h4>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        <div class="widgets-icons-2 rounded-circle text-white m-auto"><img src="<?php echo e(asset('assets/images/institute-Mix.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 text-dark" id="mixed_count" data-original="<?php echo e(customNumFormat($propertyTypeCount['Mixed'])); ?>"><?php echo e(customNumFormat($propertyTypeCount['Mixed'])); ?></h4>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        <div class="widgets-icons-2 rounded-circle text-white m-auto"><img src="<?php echo e(asset('assets/images/institute-Other.svg')); ?>" alt="properties">
                        </div>
                        <div>
                            <h4 class="my-1 text-dark" id="others_count" data-original="<?php echo e(customNumFormat($propertyTypeCount['Others'])); ?>"><?php echo e(customNumFormat($propertyTypeCount['Others'])); ?></h4>
                        ...
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($counts[$i].' ('. round(($counts[$i]/$totalCount)*100, 2).'%)'); ?></td>
                                    <td><?php echo e($areas[$i].' ('. round(($areas[$i]/$totalAreaInSqm)*100, 2). '%)'); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th>Grand Total</th>
                                    <th><?php echo e($totalCount); ?></th>
                                    <th><?php echo e(round($totalAreaInSqm,3)); ?> (<?php echo e(round($totalAreaInAcre,3)); ?> Acres)</th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
