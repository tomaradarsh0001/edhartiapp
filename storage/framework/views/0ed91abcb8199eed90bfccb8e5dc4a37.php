...
<html lang="en">
<head>
    <title>eDharti | <?php echo $__env->yieldContent('title'); ?></title>
    ...
    <!-- Custom Stylesheet -->
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('assets/frontend/assets/css/style.css')); ?>">
    <link rel="stylesheet" type="text/css" id="style_sheet" href="<?php echo e(asset('assets/frontend/assets/css/skins/default.css')); ?>">
    <link rel="stylesheet" type="text/css" id="style_sheet" href="<?php echo e(asset('assets/frontend/assets/css/custom.css')); ?>">
    <style>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 col-7">
              <a class="navbar-brand" href="#">
                  <img src="<?php echo e(asset('assets/frontend/assets/img/LDOLogo-white.png')); ?>" alt="Land and Development Office" height="60">
                </a>
          </div>
          <div class="col-lg-6 col-5 text-end">
            <div class="d-flex justify-content-end"><img src="<?php echo e(asset('assets/frontend/assets/img/eDharti-Logo-white.png')); ?>" alt="logo" class="edharti-logo"><span class="text-white">2.0</span></div>
        </div>
        </div>
      </div>
  </nav>
...
<!-- Button trigger modal -->
            ...
            <form action="#" id="otp-form">
                <div class="otp-receive-container">
                    <div class="otp_input_groups">
                      ...
                      <button type="button" id="verifyMobileOtpBtn" class="btn otp_verify_btn">Verify Account</button>
      ...
      <div class="modal-content">
        <div class="modal-body">
            ...
            <form action="#" id="otp-form-email">
                <div class="otp-receive-container">
                    <div class="otp_input_groups">
                            <input type="text" class="otp_input_email otp_input" autofocus pattern="\d*" maxlength="1" />
                            <input type="text" class="otp_input_email otp_input" maxlength="1" />
                            <input type="text" class="otp_input_email otp_input" maxlength="1" />
                            <input type="text" class="otp_input_email otp_input" maxlength="1" />
                      </div>
                      <button type="button" id="verifyEmailOtpBtn" class="btn otp_verify_btn">Verify Account</button>
                      <p class="resent_otp">Didn't receive code? <a href="#">Resend</a></p>
                </div>
            </form>
        </div>
 ...
 <!-- End -->
  ...
  <div class="modal fade" id="orgOtpMobile" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
            <div class="otp-title">
            ...
            <form action="#" id="org-otp-form">
                <div class="otp-receive-container">
                    <div class="otp_input_groups">
                            <input type="text" class="otp_input org_mobile_otp_nput" autofocus pattern="\d*" maxlength="1" />
                            <input type="text" class="otp_input org_mobile_otp_nput" maxlength="1" />
                            <input type="text" class="otp_input org_mobile_otp_nput" maxlength="1" />
                            <input type="text" class="otp_input org_mobile_otp_nput" maxlength="1" />
                      </div>
                      <button type="button" id="orgVerifyMobileOtpBtn" class="btn otp_verify_btn">Verify Account</button>
                      <p class="resent_otp">Didn't receive code? <a href="#">Resend</a></p>
                </div>
            </form>
        </div>
 ...
 <!-- End -->
  ...
  <div class="modal fade" id="orgOtpEmail" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
            <div class="otp-title">
            ...
            <form action="#" id="org-otp-form-email">
                <div class="otp-receive-container">
                    <div class="otp_input_groups">
                            <input type="text" class="org_otp_input_email otp_input" autofocus pattern="\d*" maxlength="1" />
                            <input type="text" class="org_otp_input_email otp_input" maxlength="1" />
                            <input type="text" class="org_otp_input_email otp_input" maxlength="1" />
                            <input type="text" class="org_otp_input_email otp_input" maxlength="1" />
                      </div>
                      <button type="button" id="orgVerifyEmailOtpBtn" class="btn otp_verify_btn">Verify Account</button>
                      <p class="resent_otp">Didn't receive code? <a href="#">Resend</a></p>
                </div>
            </form>
        </div>
...
<script src="<?php echo e(asset('assets/frontend/assets/js/popper.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/bootstrap.bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/otp-input.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/assets/js/appointment-validation.js')); ?>"></script>
...
$(document).ready(function() {
    ...
    $('#locality').on('change', function () {
        ...
        $("#block").html('');
        $.ajax({
            url: "<?php echo e(route('localityBlocks')); ?>",
            type: "POST",
            data: {
                locality: locality,
                _token: '<?php echo e(csrf_token()); ?>'
    ...
    $('#block').on('change', function () {
        ...
        $("#plot").html('');
        $.ajax({
            url: "<?php echo e(route('blockPlots')); ?>",
            type: "POST",
            data: {
                locality: locality,
                block: block,
            ...
            success: function (result) {
                ...
                $.each(result, function (key,value) {
                    ...
                    $("#plot").append('<option value="' + value.plot_or_property_no + '">' + value.plot_or_property_no + '</option>');
                });
            }
        });
    });
    ...
    $('#plot').on('change', function () {
        ...
        $("#knownas").html('');
        $.ajax({
            url: "<?php echo e(route('plotKnownas')); ?>",
            type: "POST",
            data: {
                locality: locality,
                block: block,
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result, function (key,value) {
                    ...
                    $("#plot_org").append('<option value="' + value.plot_or_property_no + '">' + value.plot_or_property_no + '</option>');
                });
            }
        });
    });
    ...
    function getSubTypesByType(type,subtype){
        ...
        $(`#${subtype}`).html('');
        $.ajax({
            url: "<?php echo e(route('prpertySubTypes')); ?>",
            type: "POST",
            data: {
...
</html><?php /**PATH C:\Users\shubh\Desktop\new 22 august\eDharti\resources\views/layouts/public/app.blade.php ENDPATH**/ ?>