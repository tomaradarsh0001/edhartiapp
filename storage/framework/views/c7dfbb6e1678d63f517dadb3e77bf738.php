...
<?php $__env->startSection('title', 'L&DO Visitor Appointment'); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div id="appointment">
                        ...
                        <!-- Start of the Form -->
                        <form action="<?php echo e(route('appointmentStore')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                            ...
                                            <div class="ifyes internal_container my-2" id="ifyes" style="display: none;">
                                                <div class="container-fluid">
                                                    <div class="row less-padding-input">
                                                        ...
                                                        <div class="col-lg-6 col-12">
                                                            <div class="form-group form-box">
                                                                <input type="text" name="knownasFill" id="knownasFill" class="form-control alpha-only" placeholder="Known As (Optional)">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group form-box">
                                            <select name="meetingPurpose" id="meetingPurpose" class="form-select">
                                                ...
                                                <?php $__currentLoopData = $meetingPurposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purpose): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<!-- 
<script src="<?php echo e(asset('js/appointment-validation.js')); ?>"></script> -->
